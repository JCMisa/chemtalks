        ...
        <div className=''>
            <div className='my-10 p-10'>
                ...
                <div className='mt-3 flex flex-col xl:flex-row gap-10 w-full'>
                    {/* easy */}
                    <div className='flex flex-col' onClick={() => router.push(`/questions/easy/${params?.branch}`)}>
                    ...
                    {/* medium */}
                    <div className='flex flex-col' onClick={() => router.push(`/questions/medium/${params?.branch}`)}>
                    ...
                    {/* hard */}
                    <div className='flex flex-col' onClick={() => router.push(`/questions/hard/${params?.branch}`)}>
                        <div className='flex items-center justify-center relative'>
